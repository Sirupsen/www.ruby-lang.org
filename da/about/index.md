...
Undrer du dig over hvorfor Ruby er så populært? Rubys fans kalder det et smukt,
kunstnerisk sprog. Og alligevel handy og praktisk.
...
### Idealerne fra Rubys skaber

Ruby er et nøje afvejet sprog. Dets skaber, [Yukihiro “Matz”
Matsumoto][1], har tager dele fra sine yndlingssprog (Perl, Smalltalk, Eiffel,
Ada og Lisp) for at forme et nyt sprog, som balancer funktionel
og imperativ programmering.

Matz har ofte sagt, at han tilstræber at "forsøge at gøre Ruby naturligt, ikke
simpelt" på en måde som ligner livet.

Han tilføjer:

> Ruby fremstår simpelt, men er komplekst inden i, som menneskekroppen.
...
Siden Ruby så dagens lys i 1995, har det tiltrukket mange programmører i hele
verden. I 2006, blev Ruby accepteret på stor skala, med aktive brugergrupper i
nogle af verdens største byer og Ruby-relaterede konferencer blev populære.

![Graf af
Gmane.](http://gmane.org/plot-rate.php?group=gmane.comp.lang.ruby.general&amp;width=320&amp;height=160&amp;title=Ruby-Talk+Activity
"Graf af Gmane."){: style="padding-left:8px;"}
{: style="float:right"}

Ruby-Talk den primære [mailing list](/en/community/mailing-lists/) for
diskussion om Ruby-sproget, nåede gennemsnitligt 200 daglige beskeder i 2006.
Det er faldet siden hvor diskussionen er blevet mere spredt til flere mindre
grupper og medier.

[TIOBE indekset][6] som måler brugervæksten hos forskellige programmeringssprog
rangerer Ruby som det 9. mest populære programmeringssprog i verden. En stor del
af Rubys brugere skyldes populariteten af Ruby software som Ruby on Rails.

Ruby er også [gratis]({{ site.license.url }}). Ikke bare gratis at bruge, men
også gratis at kopiere, ændre og distribuere.
